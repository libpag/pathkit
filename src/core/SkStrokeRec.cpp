...
#define kStrokeRec_FillStyleWidth (-PK_Scalar1)
...
void SkStrokeRec::init(const SkPaint& paint, SkPaint::Style style, SkScalar resScale) {
    ...
    switch (style) {
        ...
        case SkPaint::kStrokeAndFill_Style:
            ...
            break;
        default:
            PkDEBUGFAIL("unknown paint style");
...
SkScalar SkStrokeRec::GetInflationRadius(const SkPaint& paint, SkPaint::Style style) {
    SkScalar width = SkPaint::kFill_Style == style ? -PK_Scalar1 : paint.getStrokeWidth();
