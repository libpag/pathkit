...
#ifdef PK_DEBUG
#if DEBUG_COINCIDENCE
#define PkOPASSERT(cond) PkASSERT((this->globalState() && \
...
#define PkOPASSERT(cond) PkASSERT((this->globalState() && \
        this->globalState()->debugSkipAssert()) || (cond))
#endif
#define PkOPOBJASSERT(obj, cond) PkASSERT((obj->globalState() && \
        obj->globalState()->debugSkipAssert()) || (cond))
#else
#define PkOPASSERT(cond)
#define PkOPOBJASSERT(obj, cond)
#endif

// Use Almost Equal when comparing coordinates. Use epsilon to compare T values.
bool AlmostEqualUlps(float a, float b);
inline bool AlmostEqualUlps(double a, double b) {
    return AlmostEqualUlps(PkDoubleToScalar(a), PkDoubleToScalar(b));
}

bool AlmostEqualUlpsNoNormalCheck(float a, float b);
inline bool AlmostEqualUlpsNoNormalCheck(double a, double b) {
    return AlmostEqualUlpsNoNormalCheck(PkDoubleToScalar(a), PkDoubleToScalar(b));
}

bool AlmostEqualUlps_Pin(float a, float b);
inline bool AlmostEqualUlps_Pin(double a, double b) {
    return AlmostEqualUlps_Pin(PkDoubleToScalar(a), PkDoubleToScalar(b));
}
...
inline bool NotAlmostEqualUlps(double a, double b) {
    return NotAlmostEqualUlps(PkDoubleToScalar(a), PkDoubleToScalar(b));
}

bool NotAlmostEqualUlps_Pin(float a, float b);
inline bool NotAlmostEqualUlps_Pin(double a, double b) {
    return NotAlmostEqualUlps_Pin(PkDoubleToScalar(a), PkDoubleToScalar(b));
}

bool NotAlmostDequalUlps(float a, float b);
inline bool NotAlmostDequalUlps(double a, double b) {
    return NotAlmostDequalUlps(PkDoubleToScalar(a), PkDoubleToScalar(b));
}
...
inline bool AlmostBequalUlps(double a, double b) {
    return AlmostBequalUlps(PkDoubleToScalar(a), PkDoubleToScalar(b));
}

bool AlmostPequalUlps(float a, float b);
inline bool AlmostPequalUlps(double a, double b) {
    return AlmostPequalUlps(PkDoubleToScalar(a), PkDoubleToScalar(b));
}

bool RoughlyEqualUlps(float a, float b);
inline bool RoughlyEqualUlps(double a, double b) {
    return RoughlyEqualUlps(PkDoubleToScalar(a), PkDoubleToScalar(b));
}

bool AlmostLessUlps(float a, float b);
inline bool AlmostLessUlps(double a, double b) {
    return AlmostLessUlps(PkDoubleToScalar(a), PkDoubleToScalar(b));
}

bool AlmostLessOrEqualUlps(float a, float b);
inline bool AlmostLessOrEqualUlps(double a, double b) {
    return AlmostLessOrEqualUlps(PkDoubleToScalar(a), PkDoubleToScalar(b));
}

bool AlmostBetweenUlps(float a, float b, float c);
inline bool AlmostBetweenUlps(double a, double b, double c) {
    return AlmostBetweenUlps(PkDoubleToScalar(a), PkDoubleToScalar(b), PkDoubleToScalar(c));
}

int UlpsDistance(float a, float b);
inline int UlpsDistance(double a, double b) {
    return UlpsDistance(PkDoubleToScalar(a), PkDoubleToScalar(b));
}
...
inline bool between(double a, double b, double c) {
    PkASSERT(((a <= b && b <= c) || (a >= b && b >= c)) == ((a - b) * (c - b) <= 0)
...
#ifdef PK_DEBUG
    switch (points) {
        case 0: PkASSERT(SkPath::kMove_Verb == verb); break;
        case 1: PkASSERT(SkPath::kLine_Verb == verb); break;
        case 2: PkASSERT(SkPath::kQuad_Verb == verb); break;
        case 3: PkASSERT(SkPath::kCubic_Verb == verb); break;
        default: PkDEBUGFAIL("should not be here");
    }
#endif
...
#ifdef PK_DEBUG
    switch (verb) {
        case SkPath::kLine_Verb: PkASSERT(1 == points); break;
        case SkPath::kQuad_Verb: PkASSERT(2 == points); break;
        case SkPath::kConic_Verb: PkASSERT(2 == points); break;
        case SkPath::kCubic_Verb: PkASSERT(3 == points); break;
        default: PkDEBUGFAIL("should not get here");
    }
#endif
    return points;
}
