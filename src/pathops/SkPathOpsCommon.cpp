...
SkOpSegment* FindChase(SkTDArray<SkOpSpanBase*>* chase, SkOpSpanBase** startPtr,
    ...
    while (chase->count()) {
        ...
        *endPtr = nullptr;
        ...
        int sumWinding PK_INIT_TO_AVOID_WARNING;
        if (sortable) {
            segment = angle->segment();
        ...
        while ((angle = angle->next()) != firstAngle) {
            ...
            int maxWinding PK_INIT_TO_AVOID_WARNING;
            if (sortable) {
            ...
            if (!segment->done(angle)) {
                ...
                if (sortable) {
                    ...
                    PkAssertResult(segment->markAngle(maxWinding, sumWinding, angle, nullptr));
                }
            }
        }
        if (first) {
