...
// This file may assume <= SSE2, but must check PK_CPU_SSE_LEVEL for anything more recent.
...
public:
    ...
    AI SkNx abs() const {
#if PK_CPU_SSE_LEVEL >= PK_CPU_SSE_LEVEL_SSSE3
...
#if 0 && PK_CPU_SSE_LEVEL >= PK_CPU_SSE_LEVEL_SSE41
